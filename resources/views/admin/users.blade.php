                        ...
                        <tr>
                            <td>
                                <h2 class="table-avatar">
                                    <a href="{{ route('dashboard.clients.profile', ['slug' => $user->slug]) }}" class="avatar">
                                        <img alt="" src="{{ $user->profile_pic_url }}">
                                    </a>
                                    
                                    <a href="{{ route('dashboard.clients.profile', ['slug' => $user->slug]) }}">
                                        {{ $user->full_name }} <span class="text-uppercase">{{ $user->role }}</span>
                                    </a>
                                </h2>
                            </td>
                            ...
                            <td class="text-end">
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_user"><i class="fa fa-pencil m-r-5"></i>
                                            Edit</a>
